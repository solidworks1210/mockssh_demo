...
def runServer(commands, prompt="$ ", keypath=".", interface='', port=2222, **users):
    """
    启动模拟器
...
def startThreadedServer(commands, prompt="$ ", keypath=".", interface='', port=2222, **users):
    """
...
if __name__ == "__main__":
    users0 = {'root': 'x'}
    commands0 = [command_exit]
    runServer(commands0, **users0)
